# Model C Freeze Benchmark: thin_line

## Question

Model Cは `thin_line` guideで、noisy static guide direct displayに対して安定した再構成候補を出せるか。
...
- Decoder seed: 4203
- Input guide: synthetic `thin_line` with deterministic Gaussian noise
- Input size: 32x32
- Output size: 32x32
- Model: Model C
...
| --- | ---: | ---: |
| MAD vs clean guide | 0.012734 | 0.006110 |
| Foreground mean | 0.511896 | 0.497693 |
| Background mean | 0.012467 | 0.005553 |
| Edge leakage | 0.011939 | 0.007054 |
| Foreground variance | 0.000657 | 0.000901 |
| Background variance | 0.000303 | 0.000160 |
| Decode time seconds | 0.000000 | 0.656073 |
