# Model C Freeze Benchmark: circle

## Question

Model Cは `circle` guideで、noisy static guide direct displayに対して安定した再構成候補を出せるか。
...
- Date: 2026-05-16
- Experiment seed: 20260518
- Decoder seed: 4202
- Input guide: synthetic `circle` with deterministic Gaussian noise
- Input size: 32x32
- Output size: 32x32
- Model: Model C
...
| --- | ---: | ---: |
| MAD vs clean guide | 0.014483 | 0.009306 |
| Foreground mean | 0.502721 | 0.503817 |
| Background mean | 0.011839 | 0.005878 |
| Edge leakage | 0.011804 | 0.005129 |
| Foreground variance | 0.000991 | 0.000790 |
| Background variance | 0.000295 | 0.000163 |
| Decode time seconds | 0.000000 | 0.627884 |
